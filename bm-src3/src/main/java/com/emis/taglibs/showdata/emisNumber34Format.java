/* $Id: emisNumber34Format.java 4 2015-05-27 08:13:47Z andy.he $
 *
 ...
 */
public class emisNumber34Format extends emisValidFormat {
  /**
   * Constructor.
   */
  public emisNumber34Format (){
    this.sType_ = "NUMBER3_4";
    setPicture("N");
  }
  ...
  protected String getOnBlur() {
    ...
    _sbPattern.append(" onblur=\"emisNumValid(this, 3 ,4, '")
...
/*
    ...
    if (this.sDisplayType_.indexOf("R") >= 0 ) {
      ...
      _sPattern += " onblur=\"emisNumValid(this, 3 , 4, '"+this.sAlertMessage_ +"', '',"+this.sPage_+" ) ";
