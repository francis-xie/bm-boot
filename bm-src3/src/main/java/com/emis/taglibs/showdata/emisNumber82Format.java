/* $Id: emisNumber82Format.java 4 2015-05-27 08:13:47Z andy.he $
 *
 ...
 * @version 2004/08/09 Jerry: refactor
 */
public class emisNumber82Format extends emisValidFormat {
  /**
   * HTML tag.
   */
  public emisNumber82Format () {
    this.sType_ = "NUMBER8_2";
    setPicture("N");
  }
  ...
  protected String getOnBlur() {
    ...
    _sbPattern.append(" onblur=\"emisNumValid(this, 8 ,2, '")
...
/*
    ...
    if (this.sDisplayType_.indexOf("R") >= 0 ) {
      ...
      _sPattern += " onblur=\"emisNumValid(this, 8 ,2, '"+this.sAlertMessage_ +"', '',"+ this.sPage_+" ) ";
