/* $Id: emisShowSelectWindow.java 4 2015-05-27 08:13:47Z andy.he $
 *
 ...
 * @version 2004/08/28
 */
public class emisShowSelectWindow extends TagSupport {
  private String name;
  /** script的text檔, 如: "part_sel.txt", "vendor_sel.txt" */
  private String type;
  ...
  public int doStartTag() {
    try {
      ...
      System.err.println("emisShowSelectWindow.doStartTag: " + e.getMessage());
    }
    return (SKIP_BODY);
  }
  ...
  private void genScript(ServletContext oContext, JspWriter out) throws Exception {
    ...
    try {
      ...
      String _sFileName = getType();
      System.out.println("fn=" + _sFileName);
      emisFile _oFile = _oDir.getFile(_sFileName);
      ...
      System.err.println("emisShowSelectWindow.genScript: " + e.getMessage());
    } finally {
      if (_oReader != null) {
        _oReader.close();
        _oReader = null;
