 ...
 * Time: 5:55:58 PM
 */
public final class emisMiGetCreUser extends emisMiAction {
//    private emisMiSeq action = new emisMiSeq();
  ...
  public final String act(final String[] src, final String[] param) throws SQLException {
    ...
    if (db == null) {
      db = config.getDb();
      final String sql = " select SH_NO, FLS_NO, CRE_USER from  SHIP_H where s_no_in = ? and PO_NO='PO'+? and  SH_CTN_NO = ? and s_no_out=? and fls_no != 'CL'";
