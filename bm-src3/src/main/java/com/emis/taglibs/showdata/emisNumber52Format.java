...
/**
 * Number format: 123.5678.
 * @author age
 * @version Apr 8, 2009, 6:34:16 PM
 * @version 2009/05/25  for  landis  幣值匯率
 */
public class emisNumber52Format extends emisValidFormat {
  /**
   * Constructor.
   */
  public emisNumber52Format(){
    this.sType_ = "NUMBER5_2";
    setPicture("N");
  }
  ...
  protected String getOnBlur() {
    ...
    _sbPattern.append(" onblur=\"emisNumValid(this, 5 ,2, '")
...
/*
    ...
    if (this.sDisplayType_.indexOf("R") >= 0 ) {
      ...
      _sPattern += " onblur=\"emisNumValid(this, 5 , 4, '"+this.sAlertMessage_ +"', '',"+this.sPage_+" ) ";
