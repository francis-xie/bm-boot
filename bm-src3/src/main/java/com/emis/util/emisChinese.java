...

{
     ...
     *  @param String _str - Ex:"中文123也可以"<BR>

     *  @param int transfer_flag - <BR>
     ...
     *  @param String iNum - A digital string prepared to transfered to string<BR>
     ...
     *  @param int iNum - An Integer Number prepared to transfered to string<BR>
...

    {
        ...
        // - Integer.MIN_VALUE will still be
...

    {
        ...
        // else the number at least will have one character
     ...
     *  @param int trans_flag - (see below)
     ...
     *  @param int Len - 所希望切割的長度(Byte 為單位),<BR>
